// api/jobs.js
// Serves filtered jobs from Supabase database
// Fast response - reads from DB, no NHS Jobs fetching needed
...
// Category definitions - inc/exc for title matching
...
const ADMIN_INC = ['administrative assistant','administrator','administration officer','administrative officer','administrative coordinator','senior administrator','administration team leader','office administrator','business administrator','executive administrator','receptionist','medical receptionist','senior receptionist','outpatient receptionist','ward receptionist','clinic receptionist','health records receptionist','switchboard operator','medical secretary','senior medical secretary','personal assistant','executive assistant','team secretary','clinical secretary','divisional secretary','directorate secretary','executive support officer','patient services administrator','patient pathway coordinator','patient pathway administrator','patient access administrator','patient booking coordinator','appointments administrator','admissions officer','admissions coordinator','waiting list coordinator','referral coordinator','clinic coordinator','outpatient administrator','theatre booking coordinator','cancer pathway coordinator','health records clerk','health records officer','medical records officer','medical records administrator','clinical coding administrator','records coordinator','hr administrator','workforce administrator','recruitment administrator','medical staffing administrator','esr administrator','people administrator','workforce officer','learning and development administrator','temporary staffing administrator','finance administrator','finance assistant','accounts assistant','payroll administrator','procurement administrator','purchasing officer','supplies administrator','accounts payable officer','accounts receivable officer','information administrator','data administrator','information officer','data quality officer','systems administrator','digital administrator','epr administrator','clinical systems administrator','governance administrator','quality administrator','risk administrator','compliance administrator','audit administrator','complaints administrator','patient safety administrator','project administrator','project support officer','programme support officer','pmo administrator','project coordinator','transformation administrator','service improvement administrator','operational administrator','operations coordinator','service administrator','directorate administrator','department administrator','divisional administrator','business support officer','business support administrator','operational support officer','community administrator','mental health administrator','community team administrator','crisis team administrator','camhs administrator','therapy administrator','maternity administrator','neonatal administrator','paediatric administrator','research administrator','clinical trials administrator','medical education administrator','training administrator','education coordinator','corporate administrator','board administrator','committee administrator','corporate governance administrator','executive office administrator','senior administrative officer','administration manager','office manager','business manager','operations manager','corporate services manager','service manager','general manager','communications manager','communications officer','communications adviser','senior communications officer','head of communications','media officer','press officer','social media manager','internal communications manager','public affairs manager','stakeholder engagement manager','marketing manager','content manager','patient engagement manager','patient experience manager','community engagement manager','policy officer','policy manager','policy adviser','information governance officer','data protection officer','foi officer','facilities manager','facilities officer','facilities coordinator'];
const ADMIN_EXC = ['nurse','nursing','doctor','consultant','registrar','physician','surgeon','midwife','therapist','pharmacist','radiographer','psychologist','paramedic','sonographer','support worker','healthcare assistant','hca','biomedical','social worker','scientist','technician'];
const HR_INC = ['hr assistant','hr administrator','hr officer','hr adviser','hr advisor','senior hr adviser','hr business partner','senior hr business partner','lead hr business partner','hr manager','head of human resources','director of human resources','chief people officer','workforce administrator','workforce officer','workforce adviser','workforce information officer','workforce analyst','workforce planning analyst','workforce planning manager','workforce development manager','workforce transformation manager','workforce project manager','recruitment administrator','recruitment officer','recruitment adviser','recruitment business partner','recruitment manager','resourcing officer','resourcing adviser','talent acquisition adviser','talent acquisition partner','talent acquisition manager','medical recruitment officer','medical staffing officer','medical staffing manager','employee relations officer','employee relations adviser','senior employee relations adviser','employee relations manager','case manager hr','hr case adviser','learning and development administrator','learning and development officer','learning and development adviser','learning and development manager','l&d administrator','l&d officer','l&d manager','organisational development officer','organisational development adviser','od business partner','od manager','leadership development manager','training coordinator','education coordinator','esr administrator','esr officer','esr systems analyst','payroll officer','payroll manager','hr systems administrator','hr systems analyst','hris analyst','reward adviser','reward manager','job evaluation adviser','edi officer','edi adviser','inclusion manager','workforce equality officer','staff experience officer','staff wellbeing officer','wellbeing adviser','health and wellbeing manager','staff experience manager','hr project officer','hr project manager','workforce transformation officer','people transformation manager','hr change manager','hr analyst','people analyst','workforce information analyst','hr data analyst','people analytics manager','hr reporting analyst','deputy head of hr','head of people','head of workforce','associate director of hr','deputy director of hr','director of workforce','director of people'];
const HR_EXC = ['nurse','doctor','support worker','healthcare assistant','project manager','programme manager','it engineer','software','biomedical','radiographer','pharmacist'];
const PM_INC = ['project support officer','project administrator','project coordinator','pmo administrator','pmo support officer','programme support officer','transformation support officer','change support officer','improvement support officer','assistant project manager','junior project manager','project manager','senior project manager','digital project manager','it project manager','capital project manager','estates project manager','clinical project manager','transformation project manager','workforce project manager','epr project manager','service improvement project manager','operational project manager','programme project manager','programme manager','senior programme manager','transformation programme manager','digital programme manager','clinical programme manager','workforce programme manager','strategic programme manager','improvement programme manager','programme delivery manager','pmo officer','pmo analyst','pmo coordinator','pmo manager','senior pmo manager','portfolio office manager','head of pmo','change manager','organisational change manager','transformation manager','service transformation manager','improvement manager','continuous improvement manager','quality improvement manager','business change manager','transformation lead','digital transformation manager','informatics project manager','it programme manager','systems implementation manager','epr implementation manager','digital delivery manager','technical project manager','data project manager','portfolio manager','head of programmes','head of transformation','associate director of programmes','deputy director of programmes','director of transformation','director of programmes'];
const PM_EXC = ['nurse','doctor','support worker','healthcare assistant','administrator','receptionist','secretary'];
const BA_INC = ['business analyst','senior business analyst','lead business analyst','principal business analyst','junior business analyst','associate business analyst','graduate business analyst','digital business analyst','clinical business analyst','technical business analyst','it business analyst','systems business analyst','data business analyst','information business analyst','healthcare business analyst','transformation business analyst','change business analyst','change analyst','transformation analyst','digital analyst','digital improvement analyst','business change analyst','service transformation analyst','service improvement analyst','transformation officer','project analyst','programme analyst','pmo analyst','portfolio analyst','benefits realisation analyst','business improvement analyst','clinical systems analyst','epr analyst','ehr analyst','clinical informatics analyst','information systems analyst','application analyst','systems analyst','digital systems analyst','configuration analyst','integration analyst','quality improvement analyst','improvement analyst','continuous improvement analyst','lean improvement analyst','service improvement officer','service improvement facilitator','performance improvement analyst','process improvement analyst','operational business analyst','business process analyst','process mapping analyst','automation analyst','rpa analyst','power platform analyst','power bi analyst','lead digital analyst','head of business analysis','head of informatics','head of digital transformation','head of business intelligence'];
const BA_EXC = ['nurse','doctor','support worker','healthcare assistant','project manager','programme manager','financial analyst'];
const DATA_INC = ['data analyst','senior data analyst','lead data analyst','principal data analyst','data engineer','analytics engineer','data warehouse developer','data scientist','information analyst','reporting analyst','performance analyst','workforce analyst','operational analyst','service analyst','insight analyst','analytics officer','power bi developer','sql developer','database administrator','dba','workforce information analyst','workforce planning analyst','people analytics analyst','hr data analyst','workforce intelligence analyst','commissioning analyst','contract performance analyst','population health analyst','clinical informatics analyst'];
const DATA_EXC = ['nurse','doctor','support worker','healthcare assistant','business analyst','project manager','business intelligence analyst'];
const BI_INC = ['business intelligence analyst','bi analyst','senior bi analyst','bi developer','business intelligence developer','bi lead','bi manager','bi engineer','power bi analyst','tableau analyst','analytics engineer','head of business intelligence'];
const IT_INC = ['it support officer','it support technician','it service desk analyst','it helpdesk analyst','desktop support engineer','field support engineer','ict support officer','ict technician','infrastructure engineer','infrastructure support engineer','infrastructure analyst','technical support engineer','technical services engineer','end user computing engineer','device deployment engineer','systems support engineer','systems administrator','windows systems administrator','linux systems administrator','network administrator','server administrator','cloud administrator','active directory administrator','microsoft 365 administrator','azure administrator','vmware administrator','network engineer','senior network engineer','network analyst','network infrastructure engineer','wireless network engineer','network operations engineer','telecommunications engineer','unified communications engineer','cloud engineer','azure cloud engineer','aws cloud engineer','devops engineer','platform engineer','site reliability engineer','kubernetes engineer','software developer','software engineer','senior software engineer','full stack developer','backend developer','frontend developer','.net developer','java developer','python developer','mobile application developer','web developer','integration developer','api developer','it engineer','ict engineer','cyber security analyst','cyber security engineer','information security officer','security operations analyst','security engineer','grc analyst','penetration tester','soc analyst','digital product manager','product owner','scrum master','agile delivery manager','clinical systems analyst','epr systems analyst','ehr analyst','clinical applications specialist','pacs administrator','ris administrator','digital clinical support analyst','biomedical engineer','clinical engineer','medical equipment engineer','medical electronics engineer','biomedical engineering technician','clinical technologist','medical device specialist'];
const IT_EXC = ['nurse','doctor','support worker','healthcare assistant','project manager','programme manager','business analyst'];
const FIN_INC = ['finance officer','finance assistant','finance administrator','finance manager','finance director','head of finance','management accountant','financial accountant','senior accountant','accounts payable officer','accounts receivable officer','payroll administrator','payroll manager','payroll officer','treasury officer','finance business partner','deputy director of finance','financial analyst','financial planning analyst','cost improvement analyst','financial reporting analyst'];
...
const EST_INC = ['estates assistant','estates administrator','estates officer','assistant estates officer','estates coordinator','estates support officer','property assistant','maintenance coordinator','facilities officer','facilities coordinator','estates manager','assistant estates manager','estates operations manager','estates maintenance manager','building services manager','property manager','facilities manager','compliance manager','contracts manager','engineering manager','hard fm manager','maintenance manager','senior estates manager','head of estates','head of estates and facilities','head of property','estates programme manager','capital projects manager','capital development manager','estate development manager','operational estates manager','infrastructure manager','engineering services manager','strategic estates manager','asset manager','associate director of estates','deputy director of estates','director of estates','chief estates officer','director of capital projects','estates compliance manager','fire safety manager','water safety manager','authorised person','responsible person','health and safety manager','energy manager','sustainability manager','environmental manager','capital projects officer','capital project manager','estates project manager','capital delivery manager','construction project manager','property surveyor','estate surveyor','commercial estates manager','lease manager','accommodation manager','electrical engineering manager','mechanical engineering manager','building services engineer','estates engineer','senior estates engineer'];
...
const CATS = {
  'admin-out':  { label:'Admin Outside London',          group:'Admin',          minBand:5, exLoc:'london',  inc:ADMIN_INC,  exc:ADMIN_EXC  },
  'admin-lon':  { label:'Admin in London',               group:'Admin',          minBand:5,                  inc:ADMIN_INC,  exc:ADMIN_EXC  },
  'sw-out':     { label:'Support Worker Outside London', group:'Support Worker', minBand:3, exLoc:'london',  inc:SW_INC,     exc:SW_EXC     },
  'sw-lon':     { label:'Support Worker in London',      group:'Support Worker', minBand:3,                  inc:SW_INC,     exc:SW_EXC     },
  'sw-wm':      { label:'Support Worker West Midlands',  group:'Support Worker', minBand:3, loc:'west midlands', inc:SW_INC, exc:SW_EXC     },
  'sw-wales':   { label:'Support Worker in Wales',       group:'Support Worker', minBand:3, loc:'wales',     inc:SW_INC,     exc:SW_EXC     },
  'sw-manc':    { label:'Support Worker Manchester',     group:'Support Worker', minBand:3, loc:'manchester', inc:SW_INC,    exc:SW_EXC     },
  'sw-wy':      { label:'Support Worker W Yorkshire',    group:'Support Worker', minBand:3, loc:'leeds',     inc:SW_INC,     exc:SW_EXC     },
  'sw-ey':      { label:'Support Worker E Yorkshire',    group:'Support Worker', minBand:3, loc:'hull',      inc:SW_INC,     exc:SW_EXC     },
  'nurse':      { label:'Staff Nurse',                   group:'Nursing',        minBand:5, maxBand:5,       inc:NURSE_INC,  exc:NURSE_EXC  },
  'mh-nurse':   { label:'Mental Health Nurse',           group:'Nursing',                                    inc:MH_INC,     exc:MH_EXC     },
  'res-nurse':  { label:'Research Nurse',                group:'Nursing',                                    inc:RN_INC                     },
  'fellow':     { label:'Clinical Fellow',               group:'Clinical',                                   inc:FEL_INC                    },
  'coder':      { label:'Clinical Coder',                group:'Clinical',                                   inc:COD_INC                    },
  'diet':       { label:'Dietician',                     group:'Clinical',                                   inc:DIET_INC                   },
  'micro':      { label:'Microbiology',                  group:'Clinical',                                   inc:MICRO_INC                  },
  'phleb':      { label:'Phlebotomist Leader',           group:'Clinical',                                   inc:PHLEB_INC                  },
  'res-asst':   { label:'Research Assistant',            group:'Clinical',                                   inc:RES_INC,    exc:RES_EXC    },
  'sw3':        { label:'Social Worker',                 group:'Clinical',                                   inc:SW2_INC,    exc:SW2_EXC    },
  'data':       { label:'Data Analyst',                  group:'Professional',                               inc:DATA_INC,   exc:DATA_EXC   },
  'bi':         { label:'BI Analyst',                    group:'Professional',                               inc:BI_INC                     },
  'fin':        { label:'Finance',                       group:'Professional',                               inc:FIN_INC,    exc:FIN_EXC    },
  'hr':         { label:'HR',                            group:'Professional',                               inc:HR_INC,     exc:HR_EXC     },
  'it':         { label:'IT / Engineering',              group:'Professional',                               inc:IT_INC,     exc:IT_EXC     },
  'pm':         { label:'Project Manager',               group:'Professional',                               inc:PM_INC,     exc:PM_EXC     },
  'ba':         { label:'Business Analyst',              group:'Professional',                               inc:BA_INC,     exc:BA_EXC     },
  'log':        { label:'Logistics',                     group:'Professional',                               inc:LOG_INC                    },
  'coord':      { label:'Coordinator',                   group:'Professional',                               inc:COORD_INC                  },
  'est':        { label:'Estates',                       group:'Professional',                               inc:EST_INC                    },
};
...
function applyFilter(job, catDef, sponsorOnly) {
  ...
  // NHS only
  if (!isNhs(job.organisation)) return false;

  // Band 2 - reject
  if (all.includes('band 2') || all.includes('band two')) return false;
  if (job.band !== undefined && job.band !== null && job.band <= 2) return false;

  // Permanent only
  if (ct && !ct.includes('permanent')) return false;
  if (job.isFixedTerm) return false;

  // Full time for support workers
  if (catDef.group === 'Support Worker' && job.isPartTime) return false;
  ...
  // Bank
  if (t.includes('bank') && !t.includes('blood bank') && !t.includes('eye bank') && !t.includes('bank manager')) return false;

  // Fixed term / locum
  if (all.includes('fixed term') || all.includes('fixed-term') || all.includes('locum') || all.includes('secondment') || all.includes('temporary') || all.includes('agency')) return false;

  // Band filters
  if (catDef.minBand && job.band && job.band < catDef.minBand) return false;
  if (catDef.maxBand && job.band && job.band > catDef.maxBand) return false;

  // Location filter
  const loc = (job.location||'').toLowerCase();
  if (catDef.exLoc && loc.includes(catDef.exLoc)) return false;
  if (catDef.loc   && !loc.includes(catDef.loc))  return false;

  // Sponsorship filter
  if (sponsorOnly && !job.hasSponsor) return false;

  // Title exclusions
  if (catDef.exc && catDef.exc.some(x => t.includes(x))) return false;

  // Title inclusions
  if (catDef.inc && !catDef.inc.some(x => t.includes(x))) return false;
...
export default async function handler(req, res) {
  ...
  if (!catDef) return res.status(404).json({ error:'Unknown category' });

  // Fetch from Supabase - get jobs for this category
  const dbCategory = catDef.group; // fetch by group from DB
  const r = await fetch(
    SUPABASE_URL + '/rest/v1/jobs?category=eq.' + encodeURIComponent(dbCategory) +
    '&select=*&order=posted.desc.nullslast&limit=500',
    {
      headers: {
        'apikey':        SUPABASE_KEY,
  ...
  // Apply filters
  const filtered = allJobs.filter(j => applyFilter(j, catDef, sponsorOnly));
